...
removeByID('createindustrialchemistry:non_chemical/into_dusts/zinc')
...
removeByID('createindustrialchemistry:non_chemical/into_dusts/copper')
removeByID('createindustrialchemistry:non_chemical/into_dusts/iron')
removeByID('mw_core:sequenced_assembly/mechanism/logic')
removeByID('quark:building/crafting/compressed/berry_sack')
removeByID('quark:building/crafting/compressed/apple_crate')
removeByID('thermal:storage/apple_block')
removeByID('quark:building/crafting/compressed/carrot_crate')
removeByID('thermal:storage/carrot_block')
removeByID('quark:building/crafting/compressed/potato_crate')
removeByID('thermal:storage/potato_block')
removeByID('quark:building/crafting/compressed/beetroot_crate')
removeByID('thermal:storage/beetroot_block')
removeByID('quark:building/crafting/compressed/glowberry_sack')
removeByID('quark:building/crafting/compressed/golden_apple_crate')
removeByID('supplementaries:sugar_cube')
removeByID('quark:building/crafting/compressed/cocoa_beans_sack')
removeByID('mw_core:crafting/shaped/sweet_berry_juice')
removeByID('molotov:molotov')
removeByID('quark:building/crafting/compressed/chorus_fruit_block')
